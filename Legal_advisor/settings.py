...
DATABASES = {
    'default': {
        ...
        'NAME': 'legaladvisor_mightfind',  # Replace with your database name
        'USER': 'legaladvisor_mightfind',  # Replace with your MySQL username
        'PASSWORD':"88da7bb635dd3c6524665a0d5e9bbc21e5c60c18",  
        'HOST': 'wcd96.h.filess.io',  # The IP address of your MySQL server (usually localhost or 127.0.0.1 for XAMPP)
        'PORT': '61001',  # The port your MySQL server is running on (3306 is the default port for MySQL)
        'OPTIONS': {
            'charset': 'utf8mb4',
        },
    }
